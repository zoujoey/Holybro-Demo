...
static size_t _FileChecksum_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__FileChecksum_Request(
    full_bounded, 0);
}
...
static size_t _FileChecksum_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__FileChecksum_Response(
    full_bounded, 0);
}
