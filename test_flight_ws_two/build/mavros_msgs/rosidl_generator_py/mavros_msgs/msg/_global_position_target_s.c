...
bool mavros_msgs__msg__global_position_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._global_position_target.GlobalPositionTarget", full_classname_dest, 60) == 0);
  }
  mavros_msgs__msg__GlobalPositionTarget * ros_message = _ros_message;
  {  // header
  ...
  {  // acceleration_or_force
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->acceleration_or_force)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of GlobalPositionTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._global_position_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GlobalPositionTarget");
  ...
  {  // acceleration_or_force
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->acceleration_or_force);
    if (!field) {
      return NULL;
    }
    {
