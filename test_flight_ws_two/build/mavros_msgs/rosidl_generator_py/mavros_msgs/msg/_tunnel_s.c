...
bool mavros_msgs__msg__tunnel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._tunnel.Tunnel", full_classname_dest, 30) == 0);
  }
  mavros_msgs__msg__Tunnel * ros_message = _ros_message;
  {  // target_system
...
{
  /* NOTE(esteve): Call constructor of Tunnel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._tunnel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tunnel");
