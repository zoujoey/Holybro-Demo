...
bool mavros_msgs__msg__esc_status_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._esc_status_item.ESCStatusItem", full_classname_dest, 46) == 0);
  }
  mavros_msgs__msg__ESCStatusItem * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ESCStatusItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._esc_status_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ESCStatusItem");
