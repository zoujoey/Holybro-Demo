...
void Mavlink__rosidl_typesupport_introspection_c__Mavlink_init_function(
...
void Mavlink__rosidl_typesupport_introspection_c__Mavlink_fini_function(void * message_memory)
{
  mavros_msgs__msg__Mavlink__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_member_array[13] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_members = {
  "mavros_msgs__msg",  // message namespace
  "Mavlink",  // message name
  13,  // number of fields
  sizeof(mavros_msgs__msg__Mavlink),
  Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_member_array,  // message members
  Mavlink__rosidl_typesupport_introspection_c__Mavlink_init_function,  // function to initialize message memory (memory has to be allocated)
  Mavlink__rosidl_typesupport_introspection_c__Mavlink_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_type_support_handle = {
  0,
  &Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, msg, Mavlink)() {
  Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_type_support_handle.typesupport_identifier) {
    Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Mavlink__rosidl_typesupport_introspection_c__Mavlink_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
