...
static size_t _FileRename_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__FileRename_Request(
    full_bounded, 0);
}
...
static size_t _FileRename_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__FileRename_Response(
    full_bounded, 0);
}
