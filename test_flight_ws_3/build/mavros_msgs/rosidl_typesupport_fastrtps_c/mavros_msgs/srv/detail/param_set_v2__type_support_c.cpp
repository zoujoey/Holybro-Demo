...
static size_t _ParamSetV2_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__ParamSetV2_Request(
    full_bounded, 0);
}
...
static size_t _ParamSetV2_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mavros_msgs__srv__ParamSetV2_Response(
    full_bounded, 0);
}
