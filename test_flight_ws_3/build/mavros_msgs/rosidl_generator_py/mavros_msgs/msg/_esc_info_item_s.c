...
bool mavros_msgs__msg__esc_info_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._esc_info_item.ESCInfoItem", full_classname_dest, 42) == 0);
  }
  mavros_msgs__msg__ESCInfoItem * ros_message = _ros_message;
  {  // header
  ...
  {  // failure_flags
    ...
    ros_message->failure_flags = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // error_count
...
{
  /* NOTE(esteve): Call constructor of ESCInfoItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._esc_info_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ESCInfoItem");
