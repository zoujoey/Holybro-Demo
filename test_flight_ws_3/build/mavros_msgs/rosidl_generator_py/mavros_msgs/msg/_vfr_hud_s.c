...
bool mavros_msgs__msg__vfr_hud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._vfr_hud.VfrHud", full_classname_dest, 31) == 0);
  }
  mavros_msgs__msg__VfrHud * ros_message = _ros_message;
  {  // header
  ...
  {  // groundspeed
    ...
    assert(PyFloat_Check(field));
    ros_message->groundspeed = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // heading
  ...
  {  // climb
    ...
    assert(PyFloat_Check(field));
    ros_message->climb = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of VfrHud */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._vfr_hud");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VfrHud");
