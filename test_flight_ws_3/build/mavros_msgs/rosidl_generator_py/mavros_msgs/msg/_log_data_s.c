...
bool mavros_msgs__msg__log_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._log_data.LogData", full_classname_dest, 33) == 0);
  }
  mavros_msgs__msg__LogData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LogData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._log_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LogData");
