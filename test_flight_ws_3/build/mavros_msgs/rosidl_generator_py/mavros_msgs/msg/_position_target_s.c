...
bool mavros_msgs__msg__position_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._position_target.PositionTarget", full_classname_dest, 47) == 0);
  }
  mavros_msgs__msg__PositionTarget * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PositionTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._position_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionTarget");
