...
bool mavros_msgs__msg__waypoint_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._waypoint_list.WaypointList", full_classname_dest, 43) == 0);
  }
  mavros_msgs__msg__WaypointList * ros_message = _ros_message;
  {  // current_seq
    ...
    ros_message->current_seq = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // waypoints
...
PyObject * mavros_msgs__msg__waypoint_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._waypoint_list");
  ...
  {  // current_seq
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->current_seq);
    {
