...
bool mavros_msgs__msg__rtcm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._rtcm.RTCM", full_classname_dest, 26) == 0);
  }
  mavros_msgs__msg__RTCM * ros_message = _ros_message;
  {  // header
...
PyObject * mavros_msgs__msg__rtcm__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._rtcm");
