...
bool mavros_msgs__msg__rc_in__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._rc_in.RCIn", full_classname_dest, 27) == 0);
  }
  mavros_msgs__msg__RCIn * ros_message = _ros_message;
  {  // header
...
PyObject * mavros_msgs__msg__rc_in__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._rc_in");
