...
struct ESCTelemetry_
{
  ...
  using _esc_telemetry_type =
    std::vector<mavros_msgs::msg::ESCTelemetryItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<mavros_msgs::msg::ESCTelemetryItem_<ContainerAllocator>>::other>;
  ...
  Type & set__esc_telemetry(
    const std::vector<mavros_msgs::msg::ESCTelemetryItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<mavros_msgs::msg::ESCTelemetryItem_<ContainerAllocator>>::other> & _arg)
  {
